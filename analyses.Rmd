...
plot(as.numeric(data1$site01), data1$age_n)

#Condition plot
age_plot  <- ggplot() + 
  geom_smooth(data=data1, aes(x=age_n, y=site01)) + 
  theme_minimal() +
  ...
  ylab("Probability of capture in GS (1) or MF (0)")

#Condition plot
cond_plot  <- ggplot() + 
 geom_smooth(data=data1, aes(x=cond_n, y=site01)) + 
  theme_minimal() +
  theme(panel.grid = element_blank(),
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black"),
...
weight_plot  <- ggplot() + 
 geom_smooth(data=data1, aes(x=body_weight_kg, y=site01)) + 
  theme_minimal() +
  theme(panel.grid = element_blank(),
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black"),
...
cond_plot  <- ggplot(data=data1, aes(x = study_site, fill=condition)) + 
 geom_bar(position="fill") +
  stat_count(aes(label = ..count..), geom = "text", position = position_fill(vjust = 0.5), size = 3.5, 
             color = "white") +
  scale_fill_manual (values = c("#674A8E", "#5089A1", "#4DBC94","#C4E44D"), name = "Body condition score") +
  theme_minimal() +
  theme(panel.grid = element_blank(),
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black"),
...
age_plot  <- ggplot(data=data1, aes(x = study_site, fill=age_estimate)) +
 geom_bar(position="fill") +
  stat_count(aes(label = ..count..), geom = "text", position = position_fill(vjust = 0.5), size = 4, 
             color = "white") +
  scale_fill_manual (values = c("#674A8E", "#5089A1", "#4DBC94"), 
                     name = "Age estimate") +
  theme_minimal() +
  theme(panel.grid = element_blank(),
        axis.line.x = element_line(color = "black"),
...
weight_plot <- ggplot(data = data1, aes(x = study_site, y = body_weight_kg, fill = study_site)) +
  ...
  scale_fill_manual (values = c("#4DBC94","#C4E44D")) +
  theme_minimal() +
  theme(legend.position = "none", 
      ...
      scale_y_continuous(breaks=seq(0,2,0.5),labels=seq(0,2,0.5), limits=c(0,2)) +
      xlab("Study site") +  ylab("Body weight (kg)") + labs("")
print(weight_plot)
ggsave(filename = "morpho - weight v study site.jpeg", weight_plot, width=150, height= 150, units = "mm")
...
mod <- glm(stress_in_trap ~ temp + moon_phase + time_assaytolight + time_processtoassay, data=data1)
mod <- glm(stress_in_bag ~ temp + moon_phase + time_assaytolight + time_processtoassay, data=data1)
mod <- glm(stress_on_table ~ temp + moon_phase + time_assaytolight + time_processtoassay, data=data1)
...
groomd_site <- ggplot(data=data1, aes(x = study_site, y = grooming_d, fill=study_site)) + 
 ...
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  stat_summary(fun="median", geom="point", col="grey40", fill="white", 
               shape=21, size=1.5, stroke=1) +
  scale_fill_manual (values = c("#674A8E","#5089A1")) +
  theme_minimal() +
  theme(legend.position = "none", 
        panel.grid = element_blank(),
        axis.line.x = element_line(color = "black"),
...
emergetemp <- ggplot(data=data1, aes(x = temp, y = emerge_max)) + 
 geom_point() +
  ...
  annotate("text", x =23, y =55, label = "A", size = 10, hjust = -1)
...
emergeweight <- ggplot(data=data1, aes(x = body_weight_kg, y = emerge_max)) + 
 geom_point() +
  ...
  ylab("") + 
  labs("") +
    annotate("text", x =1.6, y =55, label = "B", size = 10, hjust = -1)
...
plot <- ggarrange(emergetemp, emergeweight)
plot <- annotate_figure(plot, 
        bottom = text_grob("Study site", size = 20))
print(plot)
ggsave(filename = "1st assay emerge plots.jpeg", plot, width=300, height= 150, units = "mm")
...
print(moved_site)
ggsave(filename = "1st assay - study site v moving dur.jpeg", moved_site, width=150, height= 150, units = "mm")
...
mod <- glm(stress_in_trap ~ temp + moon_phase + time_assaytolight + time_processtoassay, data=data2)
mod <- glm(stress_in_bag ~ temp + moon_phase + time_assaytolight + time_processtoassay, data=data2)
mod <- glm(stress_on_table ~ temp + moon_phase + time_assaytolight + time_processtoassay, data=data2)
...
groomdur <- ggplot(data=data2, aes(x = sex, y = grooming_d, fill = sex)) + 
  ...
  stat_summary(fun="median", geom="point", col="grey40", fill="white", 
             shape=21, size=1.5, stroke=1) +
  scale_fill_manual (values = c("#674A8E","#4DBC94")) +
  theme_minimal() +
  theme(legend.position = "none", 
        panel.grid = element_blank(),
        axis.line.x = element_line(color = "black"),
...
baitage <- ggplot(data=data2, aes(x = age_estimate, y = bait_eaten_g, fill = age_estimate)) + 
  ...
  stat_summary(fun="median", geom="point", col="grey40", fill="white", 
             shape=21, size=1.5, stroke=1) +
  scale_fill_manual (values = c("#674A8E","#4DBC94","#C4E44D")) +
  theme_minimal() +
  theme(legend.position = "none", 
        panel.grid = element_blank(),
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black"),
        text = element_text(size=20)) + 
  scale_y_continuous(breaks=seq(0,50,20),labels=seq(0,50,20), limits=c(0,50)) +
  xlab("Age estimate") + 
  ylab("Bait eaten (g)") + labs("") +
  scale_x_discrete(labels = c("<1yr" = "<1 year", "1-2yrs" = "1-2 years", "2-3yrs" ="2-3 years"))
print(baitage)
ggsave(filename = "2 assays raw - bait eaten v age.jpeg", baitage, width=150, height= 150, units = "mm")
...
foodo_light <- ggplot(data=data2, aes(x = time_assaytolight, y = food_o)) + 
 geom_point() +
  ...
  #scale_x_continuous(breaks=seq(10,25,5),labels=seq(10,25,5), limits=c(10,25)) +
  xlab("Time from assay to first light (mins)") + 
...
foodo_process <- ggplot(data=data2, aes(x = time_processtoassay, y = food_o)) + 
 geom_point() +
  ...
  #scale_y_continuous(breaks=seq(0,50,10),labels=seq(0,50,10), limits=c(-5,55)) +
  #scale_x_continuous(breaks=seq(10,25,5),labels=seq(10,25,5), limits=c(10,25)) +
  xlab("Time from processing to assay (mins)") + 
  ylab(expression(paste("Food interaction occurrences ", italic(" (n)")))) + labs("") 
  #annotate("text", x =23, y =55, label = "A", size = 10, hjust = -1)
...
i_gd_site <- ggplot(data=ppdata, aes(x = study_site, y = i_groomd_p, fill=study_site)) + geom_violin() +
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  stat_summary(fun="median", geom="point", col="grey40", fill="white", 
               shape=21, size=1.5, stroke=1) +
  scale_fill_manual (values = c("#674A8E","#C4E44D")) +
  theme_minimal() +
  theme(legend.position = "none", 
        panel.grid = element_blank(),
        axis.line.x = element_line(color = "black"),
  ...
  #annotate("text", x = "Mulligans Flat", y = 25, label = parse(text = "A"), size = 10, hjust = -4)
...
geom_violin() +
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "Mulligans Flat", y = 20, label = parse(text = "B"), size = 10, hjust = -4)
...
i_e_site <- ggplot(data=ppdata, aes(x = study_site, y = i_emerge_p, fill=study_site)) + 
 ...
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "Mulligans Flat", y = 35, label = parse(text = "A"), size = 10, hjust = -4)
...
#Combine plots
plot <- ggarrange(i_e_site, i_b_site)
plot <- annotate_figure(plot,
        bottom = text_grob("Study site", size = 20))
print(plot)
ggsave(filename = "intercept emerge bait.jpeg", plot, width=300, height= 150, units = "mm")
...
i_md_site <- ggplot(data=ppdata, aes(x = study_site, y = i_moved_p, fill=study_site)) + 
 ...
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  labs("") +
  annotate("text", x = "Mulligans Flat", y = 160, label = parse(text = "A"), size = 10, hjust = -4)
...
i_ld_site <- ggplot(data=ppdata, aes(x = study_site, y = i_legsd_p, fill=study_site)) + 
 ...
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  theme(legend.position = "none", 
        ...
        axis.line.y = element_line(color = "black"),
        text = element_text(size=16)) + 
  scale_y_continuous(breaks=seq(100,300,100),labels=seq(100,300,100), limits=c(100,310)) +
  xlab(" ") + 
  ylab("Adjusted hindleg stands duration (s) intercept") + labs("") +
  annotate("text", x = "Mulligans Flat", y = 310, label = parse(text = "B"), size = 10, hjust = -4)
...
#Combine plots
plot <- ggarrange(i_md_site, i_ld_site)
plot <- annotate_figure(plot,
        bottom = text_grob("Study site", size = 20))
print(plot)
ggsave(filename = "intercept move legs.jpeg", plot, width=310, height= 160, units = "mm")
...
geom_violin() +
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "Mulligans Flat", y = 200, label = parse(text = "A"), size = 10, hjust = -4)
...
i_jo_site <- ggplot(data=ppdata, aes(x = study_site, y = i_jumpo_p, fill=study_site)) + 
 ...
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  labs("") +
  annotate("text", x = "Mulligans Flat", y = 80, label = parse(text = "B"), size = 10, hjust = -4)
...
plot <- annotate_figure(plot,
        bottom = text_grob("Study site", size = 20))
print(plot)
ggsave(filename = "intercept jump.jpeg", plot, width=310, height= 160, units = "mm")
...
i_pd_site <- ggplot(data=ppdata, aes(x = study_site, y = i_perchd_p, fill=study_site)) + geom_violin() +
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "Mulligans Flat", y = 300, label = parse(text = "A"), size = 10, hjust = -4)
print(i_pd_site)
...
i_po_site <- ggplot(data=ppdata, aes(x = study_site, y = i_percho_p, fill=study_site)) + geom_violin() +
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "Mulligans Flat", y = 30, label = parse(text = "B"), size = 10, hjust = -4)
print(i_po_site)
#ggsave(filename = "intercept - study site v perch occ.jpeg", i_po_site, width=200, height= 150, units = "mm")

#Combine plots
plot <- ggarrange(i_pd_site, i_po_site)
plot <- annotate_figure(plot,
        bottom = text_grob("Study site", size = 20))
print(plot)
ggsave(filename = "intercept perching.jpeg", plot, width=300, height= 150, units = "mm")
...
geom_violin() +
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  theme(legend.position = "none", 
        ...
        axis.line.y = element_line(color = "black"),
        text = element_text(size=17)) + 
  scale_y_continuous(breaks=seq(0.9,1.6,0.1),labels=seq(0.9,1.6,0.1), limits=c(0.9,1.6)) +
  xlab("") + 
  ylab("Adjusted bag stress rating intercept") + labs("") +
  annotate("text", x = "Mulligans Flat", y = 1.6, label = parse(text = "A"), size = 10, hjust = -4)
print(i_bs_site)
...
i_ts_site <- ggplot(data=ppdata, aes(x = study_site, y = i_tablestress_p, fill=study_site)) + 
 ...
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "Mulligans Flat", y = 1.6, label = parse(text = "B"), size = 10, hjust = -4)
print(i_ts_site)
...
plot <- annotate_figure(plot,
        bottom = text_grob("Study site", size = 20))
print(plot)
ggsave(filename = "intercept stress ratings.jpeg", plot, width=300, height= 150, units = "mm")
...
i_sumsect_site <- ggplot(data=ppdata, aes(x = study_site, y = i_sumsecto_p, fill=study_site)) + 
 ...
 geom_boxplot(col="grey40", fill="grey40", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "Mulligans Flat", y = 70, label = parse(text = "A"), size = 10, hjust = -4)
...
#Combine  plots
plot <- ggarrange(i_sumsect_site, i_act_site)
plot <- annotate_figure(plot,
        bottom = text_grob("Study site", size = 20))
print(plot)
ggsave(filename = "intercept sum and total act.jpeg", plot, width=300, height= 150, units = "mm")
...
custom_colors <- c("Goorooyarroo" = "#4DBC94", "Mulligans Flat" = "#7BD151")
custom_colors <- c("Goorooyarroo" = "#674A8E", "Mulligans Flat" = "#2D718E")

#Latency to emerge vs site 
...
print(emerge)
ggsave(filename = "slope smooth - study site v emerge.jpeg", emerge, width=200, height= 150, units = "mm")
...
food <- ggplot(data=d2pred, aes(x = assay_number, y =foodd_p, color = study_site, fill = study_site)) + 
 geom_point() +
  ...
  scale_fill_manual(values = custom_colors) 
print(food)
ggsave(filename = "slope smooth - study site v food dur.jpeg", food, width=200, height= 150, units = "mm")


#Jump climb dur vs site 
jump <- ggplot(data=d2pred, aes(x = assay_number, y =jumpd_p, color = study_site, fill = study_site)) + 
 geom_point() +
  ...
  scale_fill_manual(values = custom_colors) 
print(jump)
ggsave(filename = "slope smooth - study site v jump dur.jpeg", jump, width=200, height= 150, units = "mm")

#Jump climb occ vs site 
jump <- ggplot(data=d2pred, aes(x = assay_number, y =jumpo_p, color = study_site, fill = study_site)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, aes(fill = study_site)) +
  theme_minimal() +
    theme(legend.position = "right", 
  ...
  scale_fill_manual(values = custom_colors) 
print(jump)
ggsave(filename = "slope smooth - study site v jump occ.jpeg", jump, width=200, height= 150, units = "mm")
...
perch <- ggplot(data=d2pred, aes(x = assay_number, y =perchd_p, color = study_site, fill = study_site)) + 
 geom_point() +
  ...
  scale_fill_manual(values = custom_colors) 
print(perch)
ggsave(filename = "slope smooth - study site v perch dur.jpeg", perch, width=200, height= 150, units = "mm")

#Perch occ vs site 
perch <- ggplot(data=d2pred, aes(x = assay_number, y =percho_p, color = study_site, fill = study_site)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, aes(fill = study_site)) +
  theme_minimal() +
    theme(legend.position = "right", 
  ...
  scale_fill_manual(values = custom_colors) 
print(perch)
ggsave(filename = "slope smooth - study site v perch occ.jpeg", perch, width=200, height= 150, units = "mm")
...
move <- ggplot(data=d2pred, aes(x = assay_number, y =moved_p, color = study_site, fill = study_site)) + 
 geom_point() +
  ...
  scale_fill_manual(values = custom_colors) 
print(move)
ggsave(filename = "slope smooth - study site v move dur.jpeg", move, width=200, height= 150, units = "mm")
...
bag <- ggplot(data=d2pred, aes(x = assay_number, y =bagstress_p, color = study_site, fill = study_site)) + 
 geom_point() +
  ...
  scale_fill_manual(values = custom_colors) 
print(bag)
ggsave(filename = "slope smooth - study site v bag.jpeg", bag, width=200, height= 150, units = "mm")
...
table <- ggplot(data=d2pred, aes(x = assay_number, y =tablestress_p, color = study_site, fill = study_site)) + 
 geom_point() +
  ...
  scale_fill_manual(values = custom_colors) 
print(table)
ggsave(filename = "slope smooth - study site v table.jpeg", table, width=200, height= 150, units = "mm")
...
s_e_site <- ggplot(data=ppdata, aes(x = study_site, y = s_emerge_p, fill=study_site)) + 
 geom_violin() +
  ...
  scale_fill_manual (values = c("#674A8E","#2D718E")) +
  theme_minimal() +
  theme(legend.position = "none", 
        panel.grid = element_blank(),
        axis.line.x = element_line(color = "black"),
...
print(s_e_site)
ggsave(filename = "slope blob - study site v emerge.jpeg", s_e_site, width=150, height= 150, units = "mm")
...
ggsave(filename = "slope blob - study site v food dur.jpeg", s_fd_site, width=150, height= 150, units = "mm")
...
print(s_md_site)
ggsave(filename = "slope blob - study site v movement dur.jpeg", s_md_site, width=150, height= 150, units = "mm")


#Jump + climb duration v site
s_jd_site <- ggplot(data=ppdata, aes(x = study_site, y = s_jumpd_p, fill=study_site)) + 
 geom_violin() +
  ...
  #scale_y_continuous(breaks=seq(0,120,20),labels=seq(0,120,20), limits=c(0,120)) +
  xlab(" ") + 
  ylab("Adjusted jumping + climbing duration (s) slope") + labs("") 
print(s_jd_site)
ggsave(filename = "slope blob - study site v jump dur.jpeg", s_jd_site, width=150, height= 150, units = "mm")


#Jump + climb occurrences v site
s_jo_site <- ggplot(data=ppdata, aes(x = study_site, y = s_jumpo_p, fill=study_site)) + 
 geom_violin() +
  ...
  #scale_y_continuous(breaks=seq(0,120,20),labels=seq(0,120,20), limits=c(0,120)) +
  xlab(" ") + 
  ylab(expression(paste("Adjusted jumping + climbing occurrences ", italic("(n)"), " slope")))
print(s_jo_site)
ggsave(filename = "slope blob - study site v jump occ.jpeg", s_jo_site, width=150, height= 150, units = "mm")


#Bag stress rating v site
...
print(s_bs_site)
ggsave(filename = "slope blob - study site v bag stress.jpeg", s_bs_site, width=150, height= 150, units = "mm")


#Table stress rating v site
...
print(s_ts_site)
ggsave(filename = "slope blob - study site v table stress.jpeg", s_ts_site, width=150, height= 150, units = "mm")
...
print(s_pd_site)
ggsave(filename = "slope blob - study site v perch dur.jpeg", s_pd_site, width=150, height= 150, units = "mm")
...
print(s_po_site)
ggsave(filename = "slope blob - study site v perch occ.jpeg", s_po_site, width=150, height= 150, units = "mm")



#NOT SURE HOW TO DO THIS ONE CHECK WITH BELINDA - bin data or use auto line rather than lm?
...
plot <- ggplot(data=d2pred, aes(x=assay_number, y=jumpd_p, fill=study_site
  ...
  theme(panel.grid = element_blank(),
        ...
        axis.line.y = element_line(color = "black")) +
  xlab("Assay number") + 
  ylab("Jumping + climbing duration (s) adjusted") + 
  labs("") +
    scale_x_continuous(breaks = c(min(d2pred$assay_number), max(d2pred$assay_number)))
