...
joage_plot  <- ggplot(data=data1, aes(x = age_estimate, y = jump_climb_o, fill = age_estimate)) + 
 geom_violin() +
  ...
  labs("") 
print(joage_plot)
ggsave(filename = "1st assay - age v jumping.jpeg", joage_plot, width=200, height= 150, units = "mm")
...
ggsave(filename = "1st assay - age v perching.jpeg", page_plot, width=200, height= 150, units = "mm")
...
print(psex_plot)
ggsave(filename = "1st assay - sex v perching.jpeg", psex_plot, width=200, height= 150, units = "mm")
...
#print(i_e_site)
#ggsave(filename = "intercept - study site v latency to emerge.jpeg", groomd_site, width=200, height= 150, units = "mm")
...
#print(i_b_site)
#ggsave(filename = "intercept - study site v bait.jpeg", groomd_site, width=200, height= 150, units = "mm")



#Groom duration
i_gd_site <- ggplot(data=ppdata, aes(x = study_site, y = i_groomd_p, fill=study_site)) + 
 geom_boxplot() +
  scale_fill_manual (values = c("#25798F","#7BD151")) +
  theme_minimal() +
  theme(legend.position = "none", 
...
#print(i_gd_site)
#ggsave(filename = "intercept - study site v grooming dur.jpeg", groomd_site, width=200, height= 150, units = "mm")


#Groom occurrences
i_go_site <- ggplot(data=ppdata, aes(x = study_site, y = i_groomo_p, fill=study_site)) + 
 geom_boxplot() +
  scale_fill_manual (values = c("#25798F","#7BD151")) +
  theme_minimal() +
  theme(legend.position = "none", 
...
#print(i_go_site)
#ggsave(filename = "intercept - study site v grooming occ.jpeg", groomd_site, width=200, height= 150, units = "mm")
...
#print(i_md_site)
#ggsave(filename = "intercept - study site v move dur.jpeg", groomd_site, width=200, height= 150, units = "mm")
...
#print(i_jd_site)
#ggsave(filename = "intercept - study site v jumpclimb dur.jpeg", groomd_site, width=200, height= 150, units = "mm")
...
#print(i_jo_site)
#ggsave(filename = "intercept - study site v jumpclimb occ.jpeg", groomd_site, width=200, height= 150, units = "mm")


#Perch duration
i_pd_site <- ggplot(data=ppdata, aes(x = study_site, y = i_perchd_p, fill=study_site)) + 
 geom_boxplot() +
  scale_fill_manual (values = c("#25798F","#7BD151")) +
  theme_minimal() +
  theme(legend.position = "none", 
...
#print(i_pd_site)
#ggsave(filename = "intercept - study site v perch dur.jpeg", groomd_site, width=200, height= 150, units = "mm")


#Perch occurrences
i_po_site <- ggplot(data=ppdata, aes(x = study_site, y = i_percho_p, fill=study_site)) + 
 geom_boxplot() +
  scale_fill_manual (values = c("#25798F","#7BD151")) +
  theme_minimal() +
  theme(legend.position = "none", 
...
#print(i_po_site)
#ggsave(filename = "intercept - study site v perch occ.jpeg", groomd_site, width=200, height= 150, units = "mm")
...
#print(i_ld_site)
#ggsave(filename = "intercept - study site v legs dur.jpeg", groomd_site, width=200, height= 150, units = "mm")


#Hind legs occurrences
i_lo_site <- ggplot(data=ppdata, aes(x = study_site, y = i_legso_p, fill=study_site)) + 
 geom_boxplot() +
  scale_fill_manual (values = c("#25798F","#7BD151")) +
  theme_minimal() +
  theme(legend.position = "none", 
  ...
  #scale_y_continuous(breaks=seq(0,120,20),labels=seq(0,120,20), limits=c(0,120)) +
  xlab(" ") + 
  ylab("Adjusted standing on hind legs (n) intercept") + labs("") 
annotate("text", x = "Mulligans Flat", y = 120, label = parse(text = "bold('k')"), size = 5, hjust = -5)

#print(i_lo_site)
#ggsave(filename = "intercept - study site v legs occ.jpeg", groomd_site, width=200, height= 150, units = "mm")
...
#print(i_bs_site)
#ggsave(filename = "intercept - study site v bag stress.jpeg", groomd_site, width=200, height= 150, units = "mm")
...
#print(i_ts_site)
#ggsave(filename = "intercept - study site v table stress.jpeg", groomd_site, width=200, height= 150, units = "mm")
...
#Plasticity slope plots 
```{r}

#Jumping duration v study site
plot <- ggplot(data=data2_pred, aes(x = assay_number, y = jumpd_p, fill=study_site
                                    )) + 
  geom_point() +
  ...
  xlab("Assay number") + ylab("Perching duration (s) adjusted") + labs("")
print(plot)

#Jumping occurrences v study site
plot <- ggplot(data=data2_pred, aes(x = assay_number, y = jumpo_p, fill=study_site
                                    )) + 
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_minimal() +
  theme(panel.grid = element_blank(),
        ...
        axis.line.y = element_line(color = "black")) +
  scale_x_continuous(breaks = c(0, 1, 2, 3), labels = c("0", "1", "2", "3")) +
  xlab("Assay number") + ylab("Perching occurrences (n) adjusted") + labs("")
print(plot)

#Perching duration v study site
plot <- ggplot(data=data2_pred, aes(x = assay_number, y = perchd_p, fill=study_site)) + 
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_minimal() +
  theme(panel.grid = element_blank(),
...
#Perching occurrences v study site
plot <- ggplot(data=data2_pred, aes(x = assay_number, y = percho_p, fill=study_site)) + 
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_minimal() +
  theme(panel.grid = element_blank(),
...
#Moving duration v study site
plot <- ggplot(data=data2_pred, aes(x = assay_number, y = moved_p, fill=study_site
                                    )) + 
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_minimal() +
  ...
  xlab(" ") + ylab("Quadrupedal movement duration (s) adjusted") + labs("")
print(plot)

#Table stress rating v study site
plot <- ggplot(data=data2_pred, aes(x = assay_number, y = tablestress_p, fill=study_site)) + 
  geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_minimal() +
  theme(panel.grid = element_blank(),
        ...
        axis.line.y = element_line(color = "black")) +
  #scale_x_continuous(breaks=seq(0,3,1),labels=seq(0,3,1), limits=c(0,3)) +
  xlab(" ") + ylab("Table stress rating adjusted") + labs("")
print(plot)

#Moving vs weight - no idea how to plot this....
plot <- ggplot(data=data2_pred, aes(x = body_weight_kg, y = moved_p, fill=assay_number
                                    )) + 
  #geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
  theme_minimal() +
  theme(panel.grid = element_blank(),
        ...
        axis.line.y = element_line(color = "black")) +
  #scale_x_continuous(breaks=seq(0,3,1),labels=seq(0,3,1), limits=c(0,3)) +
  xlab(" ") + ylab("Quadrupedal movement (s) adjusted") + labs("")
print(plot)

#Hind legs vs weight - no idea how to plot this....
plot <- ggplot(data=data2_pred, aes(x = body_weight_kg, y = moved_p, fill=assay_number
                                    )) + 
  #geom_point() +
  geom_smooth(method = "lm", se = TRUE) +
