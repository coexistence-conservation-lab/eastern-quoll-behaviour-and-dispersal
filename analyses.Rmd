...
data2_pred <- data2_mutate %>%
  select(-food_o, -food_d, -grooming_o, -grooming_d, 
                     ...
                     -sumsect_o, -totalact_o, -min_temp,-emerge_max, -time_to_emerge_s, -arena_entry) %>%
...
write.csv(data1_pred,"data1_pred - both assays adjusted env variables.csv")
...
mod1 <- glm(foodd_p ~ assay_number, family=gaussian, data=data2_pred)
mod2 <- glm(foodo_p ~ assay_number, family=gaussian, data=data2_pred)
mod1 <- glm(bait_p ~ assay_number, family=gaussian, data=data2_pred)

mod1 <- glm(groomd_p ~ assay_number, family=gaussian, data=data2_pred)
mod2 <- glm(groomo_p ~ assay_number, family=gaussian, data=data2_pred)

mod1 <- glm(jumpd_p ~ assay_number, family=gaussian, data=data2_pred)
mod2 <- glm(jumpo_p ~ assay_number, family=gaussian, data=data2_pred)

mod1 <- glm(legsd_p ~ assay_number, family=gaussian, data=data2_pred)
mod2 <- glm(legso_p ~ assay_number, family=gaussian, data=data2_pred)

mod1<- glm(moved_p ~ assay_number, family=gaussian, data=data2_pred)
mod2 <- glm(moveo_p ~ assay_number, family=gaussian, data=data2_pred)
mod1 <- glm(emerge_p ~ assay_number, family=gaussian, data=data2_pred)
...
tidy_results1 <- tidy(mod1)%>%
 mutate_if(is.numeric, ~round(., digits = 3))

tidy_results2 <- tidy(mod2)%>%
 mutate_if(is.numeric, ~round(., digits = 3))

table <- tidy_results1 %>%
  mutate(p.value = ifelse(p.value <= 0.05, cell_spec(p.value, bold = TRUE), p.value)) %>%
  kbl(caption = "Adjusted table stress rating", escape = FALSE) %>%
  kable_classic(full_width = F, html_font = "Times New Roman") %>%
  kable_styling(bootstrap_options = "striped", font_size = 15)
table
...
table <- tidy_results2 %>%
  mutate(p.value = ifelse(p.value <= 0.05, cell_spec(p.value, bold = TRUE), p.value)) %>%
  kbl(caption = "Adjusted total activity occurrences <em>(n)</em>", escape = FALSE) %>%
  kable_classic(full_width = F, html_font = "Times New Roman") %>%
  kable_styling(bootstrap_options = "striped", font_size = 15)
table
...
ed_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = emerge_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.y = element_line(color = "black")) + 
  xlab("") + 
  ylab(expression(paste("Adjusted latency to emerge (s)" )))+
  annotate("text", x = "2", y =50, label = parse(text = "bold('a')"), size = 5, hjust = -7) + labs("") 
print(ed_plot)
...
fo_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = foodo_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) + 
  xlab("") + ylab(expression(paste("Adjusted food interaction occurrences ", italic("(n) ")))) +
  annotate("text", x = "2", y =30, label = parse(text = "bold('b')"), size = 5, hjust = -6) + labs("") 
print(fo_plot)
...
jd_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = jumpd_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) + 
  xlab("") + ylab(expression(paste("Adjusted jumping and climbing duration (s)" )))  +
  annotate("text", x = "2", y =200, label = parse(text = "bold('c')"), size = 5, hjust = -6) + labs("") 
print(jd_plot)
...
jo_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = jumpo_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) + 
  xlab("") + ylab(expression(paste("Adjusted jumping and climbing occurrences", italic(" (n) ")))) +
  annotate("text", x = "2", y =85, label = parse(text = "bold('d')"), size = 5, hjust = -6) + labs("") 
print(jo_plot)
...
md_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = moved_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) + 
  xlab("") + ylab(expression(paste("Adjusted quadrupedal movement duration (s)" ))) +
  annotate("text", x = "2", y =160, label = parse(text = "bold('e')"), size = 5, hjust = -6) + labs("") 
print(md_plot)
...
mo_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = moveo_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) + 
  xlab("") + ylab(expression(paste("Adjusted quadrupedal movement occurrences", italic(" (n) ")))) +
  annotate("text", x = "2", y =160, label = parse(text = "bold('f')"), size = 5, hjust = -8) + labs("") 
print(mo_plot)
...
sum_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = sumsecto_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) + 
  xlab("") + ylab(expression(paste("Adjusted total different section visits", italic(" (n) ")))) +
  annotate("text", x = "2", y =70, label = parse(text = "bold('g')"), size = 5, hjust = -8) + labs("") 
print(sum_plot)
...
act_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = totalacto_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) + 
  xlab("") + ylab(expression(paste("Adjusted total activity occurrences", italic(" (n) ")))) +
  annotate("text", x = "2", y =350, label = parse(text = "bold('h')"), size = 5, hjust = -8)  + labs("") 
print(act_plot)
...
lo_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = legso_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) + 
  xlab("") + ylab(expression(paste("Adjusted standing on hind legs occurrences", italic("(n) ")))) +
  annotate("text", x = "2", y =110, label = parse(text = "bold('i')"), size = 5, hjust = -8) +
  labs("") 
print(lo_plot)
...
po_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = percho_p, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) + 
  xlab("") + ylab(expression(paste("Adjusted perching occurrences", italic(" (n) ")))) + 
  annotate("text", x = "2", y =35, label = parse(text = "bold('j')"), size = 5, hjust = -8) +
  labs("") 
print(po_plot)
...
behaviour <- ggarrange(ed_plot, fo_plot, jd_plot, jo_plot, md_plot, mo_plot, sum_plot, act_plot, lo_plot, po_plot, font.label=list(size=6, face="bold", color ="black",
ncol=2, nrow=5, #h=align, arranging matrix
label.x=0.89, label.y=0.99, hjust=-0.1, vjust=1.5))
