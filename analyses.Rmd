...
summary(glm(food_d ~ temp + arena + moon_phase + time_assaytolight, data=megadata))
summary(glm(food_o ~ temp + arena + moon_phase + time_assaytolight, data=megadata))

summary(glm(grooming_d ~ temp + arena + moon_phase + time_assaytolight, data=megadata))
summary(glm(grooming_o ~ temp + arena + moon_phase + time_assaytolight, data=megadata))

summary(glm(jump_climb_d ~ temp + arena + moon_phase + time_assaytolight, data=megadata))
summary(glm(jump_climb_o ~ temp + arena + moon_phase + time_assaytolight, data=megadata))

summary(glm(legs_d ~ temp + arena + moon_phase + time_assaytolight, data=megadata))
summary(glm(legs_o ~ temp + arena + moon_phase + time_assaytolight, data=megadata))

summary(glm(moving_d ~ temp + arena + moon_phase + time_assaytolight, data=megadata))
summary(glm(moving_o ~ temp + arena + moon_phase + time_assaytolight, data=megadata))

summary(glm(perch_d ~ temp + arena + moon_phase + time_assaytolight, data=megadata))
summary(glm(perch_o ~ temp + arena + moon_phase + time_assaytolight, data=megadata))

summary(glm(resting_d ~ temp + arena + moon_phase + time_assaytolight, data=megadata))
summary(glm(resting_o ~ temp + arena + moon_phase + time_assaytolight, data=megadata))
...
megadata_mutate <- megadata %>%
  mutate_at(vars(5, 147, 154), ~ as.vector(scale(.)))
...
#Step 2 extract predicted values for behaviour with assay number
#Step 3 extract personality and plasticity indices
#Step 4a model personality traits against demographic traits
#Step 4b model plasticity against demographic traits 
