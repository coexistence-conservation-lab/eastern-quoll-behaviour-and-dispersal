...
data <- left_join(data, bin, by=c("assay_id", "quoll_code", "session"))
#view(data)

megadata <- left_join(data, quoll, by=c("quoll_code"), relationship = "many-to-many")
...
write.csv(correlation_od, "correlation matrix occ dur.csv")
write.csv(correlation_o, "correlation matrix occ.csv")
write.csv(correlation_d, "correlation matrix dur.csv")
write.csv(correlation_ovd_act, "correlation matrix activity occ vs dur.csv")
write.csv(correlation_occ_act, "correlation matrix activity occ.csv")
write.csv(correlation_dur_act, "correlation matrix activity dur.csv")
...
jpeg(height=2000, width=2000, file="correlation matrix od.jpeg", type="cairo")
...
jpeg(height=2000, width=2000, file="correlation matrix occ.jpeg", type="cairo")
...
jpeg(height=2000, width=2000, file="correlation matrix dur.jpeg", type="cairo")
...
jpeg(height=2000, width=2000, file="correlation matrix occdur act.jpeg", type="cairo")
...
jpeg(height=2000, width=2000, file="correlation matrix occ v dur act.jpeg", type="cairo")
...
jpeg(height=2000, width=2000, file="correlation matrix occ act.jpeg", type="cairo")
...
jpeg(height=2000, width=2000, file="correlation matrix dur act.jpeg", type="cairo")
...
summary(glm(moving_d ~ study_site + temp + assay_number, data=megadata))
summary(glm(moving_o ~ study_site + temp + assay_number, data=megadata))
...
#summary(glm(formula = totalact_o ~ study_site + sex + temp + assay_number, data=sexdata)) haven't run this yet 


```


Plotting male vs female EQs by action over multiple assays

```{r}

# Append metadata for each assay to dataframe
                                              
sexdata <- left_join(data, quoll, by=c("quoll_code"), relationship = "many-to-many")

view(sexdata)


# Male v Female jumping/climbing 

jumpso <- ggplot(sexdata, aes(x = as.character(assay_number), y = jump_climb_o, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
jumpsd <- ggplot(sexdata, aes(x = as.character(assay_number), y = jump_climb_d, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
summary(glm(jump_climb_d ~ sex + temp + assay_number + study_site, data=sexdata))
summary(glm(jump_climb_o ~ sex + temp + assay_number + study_site, data=sexdata))


# Male v Female meerkatting 

legsso <- ggplot(sexdata, aes(x = as.character(assay_number), y = legs_o, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
legssd <- ggplot(sexdata, aes(x = as.character(assay_number), y = legs_d, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
summary(glm(legs_d ~ sex + temp + assay_number + study_site, data=sexdata))
summary(glm(legs_o ~ sex + temp + assay_number + study_site, data=sexdata))



# Males v Females Moving
movsd <- ggplot(sexdata, aes(x = as.character(assay_number), y = moving_d, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
movso <- ggplot(sexdata, aes(x = as.character(assay_number), y = moving_o, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
summary(glm(moving_d ~ sex + study_site + temp + assay_number, data=sexdata))
summary(glm(moving_o ~ sex + study_site + temp + assay_number, data=sexdata))

# Males v Females  Grooming
groomsd <- ggplot(sexdata, aes(x = as.character(assay_number), y = grooming_d, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
groomso <- ggplot(sexdata, aes(x = as.character(assay_number), y = grooming_o, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
summary(glm(grooming_d ~ sex + study_site + temp + assay_number, data=sexdata))
summary(glm(grooming_o ~ sex + study_site + temp + assay_number, data=sexdata))



# Males v Females Food
foods <- ggplot(sexdata, aes(x = as.character(assay_number), 
                         y = -remaining_bait_g+60, 
                         fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
...
foodsd <- ggplot(sexdata, aes(x = as.character(assay_number), y = food_d, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
foodso <- ggplot(sexdata, aes(x = as.character(assay_number), y = food_o, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
summary(glm(food_d ~ sex + study_site + temp + assay_number, data=sexdata))
summary(glm(food_o ~ sex + study_site + temp + assay_number, data=sexdata))
summary(glm(remaining_bait_g ~ sex + study_site + temp + assay_number, data=sexdata))



# Male v Female Perching 
perchsd <- ggplot(sexdata, aes(x = as.character(assay_number), y = perch_d, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
perchso <- ggplot(sexdata, aes(x = as.character(assay_number), y = perch_o, 
                        fill = as.character(assay_number))) + 
  geom_boxplot() +
  facet_wrap(~sex) + 
  theme_minimal() +
...
summary(glm(perch_d ~ sex + study_site + temp + assay_number, data=sexdata))
summary(glm(perch_o ~ sex + study_site + temp + assay_number, data=sexdata))


```


Plotting males vs females across Gooroo and MFWS

```{r}
# Male v Female jumping/climbing 

jump_sl <- ggplot(sexdata, aes(x = as.character(sex), y = jump_climb_o, 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.x = element_line(color = "black"),
        axis.line.y = element_line(color = "black")) +
  scale_fill_manual(values = c("F" = "pink", "M" = "red")) +
  xlab("Sex") + ylab("Jumping/climbing occurrences (n)") + labs("")

print(jump_sl)

jump_sld <- ggplot(sexdata, aes(x = as.character(sex), y = jump_climb_d, 
                        fill = as.character(sex))) + 
  geom_boxplot() +
  facet_wrap(~study_site) + 
  theme_minimal() +
  theme(legend.position = "none", 
        ...
        axis.line.y = element_line(color = "black")) +
  scale_fill_manual(values = c("F" = "pink", "M" = "red")) +
  xlab("Sex") + ylab("Jumping/climbing duration (s)") + labs("")
...
legs_slo <- ggplot(sexdata, aes(x = as.character(sex), y = legs_o, 
                        fill = as.character(sex))) + 
  geom_boxplot() +
  facet_wrap(~study_site) + 
  theme_minimal() +
  theme(legend.position = "none", 
        ...
        axis.line.y = element_line(color = "black")) +
  scale_fill_manual(values = c("F" = "pink", "M" = "red")) +
  xlab("Sex") + ylab("Meerkatting occurrences (n)") + labs("")

print(legs_slo)

legs_sld <- ggplot(sexdata, aes(x = as.character(sex), y = legs_d, 
                        fill = as.character(sex))) + 
  geom_boxplot() +
  facet_wrap(~study_site) + 
  theme_minimal() +
  theme(legend.position = "none", 
        ...
        axis.line.y = element_line(color = "black")) +
  scale_fill_manual(values = c("F" = "pink", "M" = "red")) +
  xlab("Sex") + ylab("Meerkatting duration (s)") + labs("")
...
# Males v Females Food
food_sl <- ggplot(sexdata, aes(x = as.character(sex), 
                         y = -remaining_bait_g+60, 
                         fill = as.character(sex))) + 
  geom_boxplot() +
  facet_wrap(~study_site) + 
  ...
  theme(legend.position = "none", 
        ...
        axis.line.y = element_line(color = "black")) +
  scale_fill_manual(values = c("F" = "pink", "M" = "red")) +
  xlab("Sex") + ylab("Bait eaten (g)") + labs("")
print(food_sl)
...
# Male v Female Perching 
perch_sld <- ggplot(sexdata, aes(x = as.character(sex), y = perch_d, 
                        fill = as.character(sex))) + 
  geom_boxplot() +
  facet_wrap(~study_site) + 
  theme_minimal() +
  theme(legend.position = "none", 
        ...
        axis.line.y = element_line(color = "black")) +
  scale_fill_manual(values = c("F" = "pink", "M" = "red")) +
  xlab("Sex") + ylab("Perching duration (s)") + labs("")

print(perch_sld)


summary(glm(legs_d ~ sex + temp + assay_number + arena + morph + study_site, data=sexdata))
summary(glm(legs_o ~ sex + temp + assay_number + arena + morph + study_site, data=sexdata))
