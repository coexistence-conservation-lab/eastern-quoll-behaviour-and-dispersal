...
# enviro vars plots - dont need these for thesis
```{r}

names(data2)

plot <- ggplot(data=data2, aes(x = moon_phase, y = legs_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#2D718E", fill = "#5089A1") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = moon_phase, y = bait_eaten_g)) + 
 geom_point(aes (colour = assay_number)) +
  geom_smooth(method = "lm", se = TRUE, colour = "#2D718E", fill = "#5089A1") +
  theme_minimal() +
    theme(legend.position = "right", 
        panel.grid = element_blank(),
...
plot <- ggplot(data=data2, aes(x = moon_phase, y = food_d)) + 
 geom_point(aes (colour = assay_number)) +
  geom_smooth(method = "lm", se = TRUE, colour = "#2D718E", fill = "#5089A1") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_assaytolight, y = food_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#2D718E", fill = "#5089A1") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_processtoassay, y = food_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#2D718E", fill = "#5089A1") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_processtoassay, y = moving_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#2D718E", fill = "#5089A1") +
  theme_minimal() +
    theme(legend.position = "right", 
...
#two assay enviro - dont need these?
```{r}
names(data2)


plot <- ggplot(data=data2, aes(x = temp, y = emerge_max)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = moon_phase, y = legs_d)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = moon_phase, y = moving_d)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = moon_phase, y = moving_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = moon_phase, y = sumsect_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = moon_phase, y = totalact_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_processtoassay, y = legs_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_processtoassay, y = moving_d)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_processtoassay, y = sumsect_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_processtoassay, y = totalact_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_assaytolight, y = jump_climb_d)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_assaytolight, y = legs_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_assaytolight, y = moving_d)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_assaytolight, y = moving_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
plot <- ggplot(data=data2, aes(x = time_assaytolight, y = totalact_o)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#1caa85", fill = "#68C6AE") +
  theme_minimal() +
    theme(legend.position = "right", 
...
print(s_jo_site)
ggsave(filename = "study site 1.jpeg", s_jo_site, width=200, height= 200, units = "mm")
...
print(jump2)
ggsave(filename = "study site 2.jpeg", jump2, width=200, height= 200, units = "mm")
