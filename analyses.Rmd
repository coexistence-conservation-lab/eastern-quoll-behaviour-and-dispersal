...
mod <- lmer(bait_eaten_g ~ study_site + sex + age_n + cond_n +
              body_weight_kg + pes_mean_mm + head_length_mm + (1|arena), 
...
mod <- lmer(emerge_max ~ study_site + sex + age_n + cond_n +
              body_weight_kg + pes_mean_mm + head_length_mm + temp + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(food_d ~ study_site + sex + age_n + cond_n + 
              body_weight_kg + pes_mean_mm + head_length_mm + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(food_o ~ study_site + sex + age_n + cond_n + 
              body_weight_kg + pes_mean_mm + head_length_mm + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(grooming_d ~ study_site + sex + age_n + cond_n + 
              body_weight_kg + pes_mean_mm + head_length_mm + temp + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(jump_climb_d ~ study_site + sex + age_n + cond_n + 
              body_weight_kg + pes_mean_mm + head_length_mm + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(moving_d ~ study_site + sex + age_n + cond_n + 
              body_weight_kg + pes_mean_mm + head_length_mm + time_assaytolight
            + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(perch_d ~ study_site + sex + age_n + cond_n +
              body_weight_kg  + pes_mean_mm + head_length_mm + temp + moon_phase
...
mod <- lmer(perch_o ~ study_site + sex + age_n + cond_n + 
              body_weight_kg + pes_mean_mm + head_length_mm + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(stress_in_bag ~ study_site + sex + age_n + cond_n + 
              body_weight_kg + pes_mean_mm + head_length_mm + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(stress_in_trap ~ study_site + sex + age_n + cond_n + 
              body_weight_kg + pes_mean_mm + head_length_mm + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(stress_on_table ~ study_site + sex + age_n + cond_n + 
              body_weight_kg + pes_mean_mm + head_length_mm + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod <- lmer(sumsect_o ~ study_site + sex + age_n + cond_n +
              body_weight_kg + pes_mean_mm + head_length_mm + (1|arena), 
            data=data1, na.action = "na.fail")
...
mod_e_age  <- lmer(emerge_max ~ age_n + (1|arena), 
            data=data1, control = control_ml, na.action = "na.fail")
mod_e_con <- lmer(emerge_max ~ cond_n + (1|arena), 
            data=data1, control = control_ml, na.action = "na.fail")
mod_e_head <- lmer(emerge_max ~ head_length_mm + (1|arena), 
            data=data1, control = control_ml, na.action = "na.fail")
mod_e_temp <- lmer(emerge_max ~ temp + (1|arena), 
            data=data1, control = control_ml, na.action = "na.fail")
models <- list(mod_e_site, mod_e_age, mod_e_con, mod_e_head, mod_e_temp)
model.names <- c("Site", "Age", "Condition", "Head length", "Temp")
...
mod_jo_sex <- lmer(jump_climb_o ~ sex + (1|arena), 
            data=data1, control = control_ml, na.action = "na.fail")
mod_jo_pes <- lmer(jump_climb_o ~ pes_mean_mm + (1|arena), 
            data=data1, control = control_ml, na.action = "na.fail")
models <- list(mod_jo_sex, mod_jo_pes)
model.names <- c("Sex", "Pes mean length")
aictab(cand.set = models, modnames = model.names)
...
behav <- ggarrange(
  ed_plot, fo_plot, jd_plot, jo_plot, md_plot, mo_plot, sum_plot, act_plot, lo_plot, po_plot,
  font.label = list(
    size = 6,
    face = "bold",
    color = "black",
...
ggsave(filename = "adjusted behaviour plots.jpeg", behav, width=300, height= 300, units = "mm")
...
write.csv(cor, "ppdata - correlation matrix.csv")
...
jpeg(height=2000, width=2000, file="pp data corplot.jpeg", type="cairo")
