...
summary(glm(food_d ~ temp + arena + moon_phase + first_light, data=megadata))
summary(glm(food_o ~ temp + arena + moon_phase + first_light, data=megadata))

summary(glm(grooming_d ~ temp + arena + moon_phase + first_light, data=megadata))
summary(glm(grooming_o ~ temp + arena + moon_phase + first_light, data=megadata))

summary(glm(jump_climb_d ~ temp + arena + moon_phase + first_light, data=megadata))
summary(glm(jump_climb_o ~ temp + arena + moon_phase + first_light, data=megadata))

summary(glm(legs_d ~ temp + arena + moon_phase + first_light, data=megadata))
summary(glm(legs_o ~ temp + arena + moon_phase + first_light, data=megadata))

summary(glm(moving_d ~ temp + arena + moon_phase + first_light, data=megadata))
summary(glm(moving_o ~ temp + arena + moon_phase + first_light, data=megadata))

summary(glm(perch_d ~ temp + arena + moon_phase + first_light, data=megadata))
summary(glm(perch_o ~ temp + arena + moon_phase + first_light, data=megadata))

summary(glm(resting_d ~ temp + arena + moon_phase + first_light, data=megadata))
summary(glm(resting_o ~ temp + arena + moon_phase + first_light, data=megadata))
