...
i_bs_site <- ggplot(data=ppdata, aes(x=site, y=i_stress_bag_p, fill=site)) + 
  ...
  annotate("text", x=0.9, y=1.3, label=expression(italic(p) == "<0.001"), size=5) +
theme_minimal() + 
  theme(legend.position="none", 
        panel.grid=element_blank(), 
        axis.line.x=element_line(colour=steel), 
...
i_e_site <- ggplot(data=ppdata, aes(x=site, y=i_emerge_p, fill=site)) + 
  ...
  annotate("text", x=0.9, y=50, label=expression(italic(p) == "<0.001"), size=5) +
  theme_minimal() + 
  theme(legend.position="none", 
        panel.grid=element_blank(), 
        axis.line.x=element_line(colour=steel), 
...
i_sumsect_site <- ggplot(data=ppdata, aes(x=site, y=i_sumsecto_p, fill=site)) + 
  ...
  stat_summary(fun="median", geom="point", col=black, fill=white, 
               shape=21, size=3, stroke=1) + 
  annotate("text", x="Mulligans Flat", y=70, label="d", size=9, hjust=-2) + 
...
i_md_site <- ggplot(data=ppdata, aes(x=site, y=i_moved_p, fill=site)) + 
  ...
  stat_summary(fun="median", geom="point", col=black, fill=white, 
               shape=21, size=3, stroke=1) + 
  annotate("text", x="Mulligans Flat", y=160, label="e", size=7, hjust=-2) + 
  annotate("text", x=0.9, y=170, label=expression(italic(p) == 0.017), size=5) +
  theme_minimal() + 
  theme(legend.position="none", 
        panel.grid=element_blank(), 
        axis.line.x=element_line(colour=steel), 
...
i_ld_site <- ggplot(data=ppdata, aes(x=site, y=i_legsd_p, fill=site)) + 
  ...
  stat_summary(fun="median", geom="point", col=black, fill=white, 
               shape=21, size=3, stroke=1) + 
  annotate("text", x="Mulligans Flat", y=300, label="f", size=7, hjust=-2) + 
  annotate("text", x=0.9, y=300, label=expression(italic(p) == "<0.001"), size=5) +
  theme_minimal() + 
  theme(legend.position="none", 
        panel.grid=element_blank(), 
        axis.line.x=element_line(colour=steel), 
...
i_jo_site <- ggplot(data=ppdata, aes(x=site, y=i_jumpo_p, fill=site)) + 
  ...
  stat_summary(fun="median", geom="point", col=black, fill=white, 
               shape=21, size=3, stroke=1) + 
  annotate("text", x="Mulligans Flat", y=90, label="g", size=7, hjust=-2) + 
  annotate("text", x=0.9, y=90, label=expression(italic(p) == "<0.001"), size=5) +
  theme_minimal() + 
  theme(legend.position="none", 
        panel.grid=element_blank(), 
        axis.line.x=element_line(colour=steel), 
...
i_jd_site <- ggplot(data=ppdata, aes(x=site, y=i_jumpd_p, fill=site)) + 
  ...
  stat_summary(fun="median", geom="point", col=black, fill=white, 
               shape=21, size=3, stroke=1) + 
  annotate("text", x="Mulligans Flat", y=220, label="h", size=7, hjust=-2) + 
  annotate("text", x=0.9, y=220, label=expression(italic(p) == "<0.001"), size=5) +
  theme_minimal() + 
  theme(legend.position="none", 
        panel.grid=element_blank(), 
        axis.line.x=element_line(colour=steel), 
...
i_pd_site <- ggplot(data=ppdata, aes(x=site, y=i_perchd_p, fill=site)) + 
  ...
  stat_summary(fun="median", geom="point", col=black, fill=white, 
               shape=21, size=3, stroke=1) + 
  annotate("text", x="Mulligans Flat", y=300, label="i", size=7, hjust=-6) + 
  annotate("text", x=0.9, y=300, label=expression(italic(p) == 0.017), size=5) +
  theme_minimal() + 
  theme(legend.position="none", 
        panel.grid=element_blank(), 
        axis.line.x=element_line(colour=steel), 
...
i_po_site <- ggplot(data=ppdata, aes(x=site, y=i_percho_p, fill=site)) + 
  ...
  stat_summary(fun="median", geom="point", col=black, fill=white, 
               shape=21, size=3, stroke=1) + 
  annotate("text", x="Mulligans Flat", y=30, label="j", size=7, hjust=-10) + 
  annotate("text", x=0.9, y=30, label=expression(italic(p) == "<0.001"), size=5) +
  theme_minimal() + 
  theme(legend.position="none", 
        panel.grid=element_blank(), 
        axis.line.x=element_line(colour=steel), 
...
```{r}
# Combine plots
plot <- ggarrange(i_bs_site, i_ts_site, i_e_site, i_sumsect_site, i_md_site,i_ld_site, i_jo_site, i_jd_site, i_pd_site, i_po_site, nrow=5, ncol=2)
