...
emergetemp <- ggplot(data=data2, aes(x = temp, y = emerge_max)) + 
 geom_point() +
  ...
  xlab(expression(paste("Ambient temperature (", degree, "C)"))) + 
  ylab("Latency to emerge (s)") + labs("") +
  annotate("text", x =25, y =60, label = "C", size = 10, hjust = 1)
print(emergetemp)
#ggsave(filename = "2 assay raw - emerge temp.jpeg", emergetemp, width=150, height= 150, units = "mm")

#Combine  plots
plot <- ggarrange(baitage, perchocc, emergetemp, ncol = 3, nrow=1)
#plot <- annotate_figure(plot, 
        #left = text_grob("Adjusted behaviours over two assays", rot=90, size = 16, face = "bold"),
        #bottom = text_grob("Study site", size = 20))
print(plot)
...
#Table stress v time process to assay
table_process <- ggplot(data=data2, aes(x = time_processtoassay, y = stress_on_table)) + 
 geom_point() +
  geom_smooth(method = "lm", se = TRUE, colour = "#AADC32", fill = "#C6E876") +
  theme_minimal() +
    theme(legend.position = "right", 
        ...
        axis.line.y = element_line(color = "black"),
        text = element_text(size=18)) + 
  scale_x_continuous(breaks=seq(50,250,50),labels=seq(50,250,50), limits=c(30,300)) +
  xlab("Time: processing to assay (mins)") + 
  ylab("Table stress rating") + labs("") +
  annotate("text", x =295, y =2, label = "I", size = 10, hjust = 1)
...
plot <- ggarrange(sum_moon, foodo_light, foodo_process, 
                  ...
                  legso_light, legso_process, table_process, 
                  ncol = 3, nrow=3) 
#plot <- annotate_figure(plot, 
        #left = text_grob("Adjusted behaviours over two assays", rot=90, size = 16, face = "bold"),
        #bottom = text_grob("Study site", size = 20))
...
fo_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = foodo_p, 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "2", y =30, label = "A", size = 10, hjust = -3) + 
  labs("") 
print(fo_plot)
...
jd_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = jumpd_p, 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "2", y =200, label = "B", size = 10, hjust = -3) +
  labs("") 
print(jd_plot)
...
jo_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = jumpo_p, 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "2", y =80, label = "C", size = 10, hjust = -2.5) + 
  labs("") 
print(jo_plot)
...
po_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = percho_p, 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  xlab("Assay number") + ylab(expression(paste("Perching occurrences ", italic(" (n) ")))) + 
    annotate("text", x = "2", y =30, label = "D", size = 10, hjust = -2.5) + 
  labs("") 
print(po_plot)
...
md_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = moved_p, 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "2", y =160, label = "E", size = 10, hjust = -3) + 
  labs("") 
print(md_plot)
...
mo_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = moveo_p, 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "2", y =150, label = "F", size = 10, hjust = -3) + 
  labs("") 
print(mo_plot)
...
lo_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = legso_p, 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "2", y =110, label = "G", size = 10, hjust = -2.5) +
  labs("") 
print(lo_plot)
...
act_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = totalacto_p, 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "2", y =400, label = "H", size = 10, hjust = -2.5) + 
  labs("") 
print(act_plot)
...
sum_plot <- ggplot(data=data2_pred, aes(x = assay_number, y = sumsecto_p, 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "2", y =80, label = "I", size = 10, hjust = -5) + 
  labs("") 
print(sum_plot)
...
plot <- ggarrange(fo_plot, jd_plot, jo_plot, 
                  po_plot, md_plot, mo_plot, 
                    lo_plot, act_plot, sum_plot, nrow=3, ncol=3)

plot <- annotate_figure(plot, 
        bottom = text_grob("Assay number", size = 24))
print(plot)
ggsave(filename = "2 assays - activity by assay number.jpeg", plot, width=375, height= 375, units = "mm")
...
i_ts_site <- ggplot(data=ppdata, aes(x = study_site, y = i_tablestress_p, fill=study_site)) + 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  annotate("text", x = "Mulligans Flat", y = 1.6, label = parse(text = "B"), size = 10, hjust = -2)
print(i_ts_site)
...
i_e_site <- ggplot(data=ppdata, aes(x = study_site, y = i_emerge_p, fill=study_site)) + 
 ...
 geom_boxplot(col="grey20", fill="grey20", width=0.02, lwd=0.5) +
  ...
  theme(legend.position = "none", 
        ...
        axis.line.y = element_line(color = "black"),
        text = element_text(size=16)) + 
  scale_y_continuous(breaks=seq(0,40,10),labels=seq(0,40,10), limits=c(0,40)) +
  xlab(" ") + 
  ylab("Adjusted latency to emerge (s) intercept") + labs("") +
  annotate("text", x = "Mulligans Flat", y = 40, label = parse(text = "C"), size = 10, hjust = -2)
print(i_e_site)
